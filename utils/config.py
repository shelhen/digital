...
KeywordBy = {
    ...
    '赵宸宇': {
        '数字技术应用z': ['数据管理', '数据挖掘', '数据网络', '数据平台', '数据中心', '数据科学', '数字控制',
                          '数字技术',
        ...
        '智能制造z': ['人工智能', '高端智能', '工业智能', '移动智能', '智能控制', '智能终端', '智能移动', '智能管理',
                      ...
                      '智能系统', '智能化', '自动控制', '自动监测', '自动监控', '自动检测', '自动生产', '数控',
                      '一体化',
                      '集成化', '集成解决方案', '集成控制', '集成系统', '工业云', '未来工厂', '智能故障诊断',
                      '生命周期管理', '生产制造执行系统', '虚拟化', '虚拟制造'],
        '现代信息系统z': ['信息共享', '信息管理', '信息集成', '信息软件', '信息系统', '信息网络', '信息终端',
                          '信息中心', '信息化', '网络化', '工业信息', '工业通信']
    },  # 99
    ...
    '数字化关键词_投资':
        [
            '软件', '网络', '客户端', '管理系统', '智能平台', '数据管理', '数据挖掘', '数据网络', '数据平台',
            '数据中心', '数据科学', '数字控制', '数字技术', '数字通信', '数字网络', '数字智能', '数字终端', '数字营销',
            '数字化', '大数据', '云计算', '云IT', '云生态', '云服务', '云平台', '区块链', '物联网', '机器学习',
            '移动互联网', '工业互联网', '产业互联网', '互联网解决方案', '互联网技术', '互联网思维', '互联网行动',
            '互联网业务', '互联网移动', '互联网应用', '互联网营销', '互联网战略', '互联网平台', '互联网模式',
            '互联网商业模式', '互联网生态', '电商', '电子商务', 'Internet', '互联网+', '线上', '线下', '线上到线下',
            '线上和线下', '020', 'B2B', 'C2C', 'B2C', 'C2B', '人工智能', '高端智能', '智能', '工业智能', '移动智能',
            '智能控制', '智能终端', '智能移动', '智能管理', '智能工厂', '智能物流', '智能制造', '智能仓储', '智能技术',
            '智能设备', '智能生产', '智能网联', '智能系统', '智能化', '自动控制', '自动监测', '自动监控', '自动检测',
            '自动生产', '数控', '一体化', '集成化', '集成解决方案', '集成控制', '集成系统', '工业云', '未来工厂',
            '智能故障诊断', '生命周期管理', '生产制造执行系统', '虚拟化', '虚拟制造', '信息共享', '信息管理',
            '信息集成', '信息软件', '信息系统', '信息网络', '信息终端', '信息中心', '信息化', '网络化', '工业信息',
            '工业通信', '机器人', '计算机技术', '电子科技', '电子商务', '电商平台', 'AI', '智慧时代', '智慧建设',
            '智慧业务', '云端', '大数据', '区块链', '云计算', '边缘计算', '信息集成', '信息技术', '信息化', '数据管理',
            '数据资产', '信息时代', '数据集成', '数据融合', '数据信息', '数字贸易', '数字体系', '数字供应链',
            '数字运营', '数字终端', '数字经济', '数字终端', '数字化', 'OA', '数字技术', '移动互联网', '办公系统',
            '办公自动化', '系统', '管理平台', 'ERP', '信息化', '物联网', '信息平台'
        ]
}
_EvaluationIndicatorSystem = {
    "盈利能力": ["净资产收益率（ROE）B", "销售期间费用率", "资产报酬率B", "息税折旧摊销前收入（EBITDA）", "营业利润率",
...
def load_ind_table():
    ...
    for key, indicator in config['数字化企业绩效评价指标体系'].items():
        ...
        for ind in indicators:
            if ind in ['董事会规模', "现金流动负债比率(%)", "资本保值增值率(%)"]:
                continue
            ind_table.append({
                "准则层": key,
                "指标层": ind,
...
tMp = {
    'X1': '净资产收益率(%)', 'X2': '资产报酬率(%)', 'X3': 'EBITDA率(%)', 'X4': '营业收入增长率(%)',
    'X5': '成本费用利润率(%)', 'X6': '总资产周转率(%)', 'X7': '应收账款周转率(%)', 'X8': '存货周转率(%)',
    'X9': '营业周期', 'X10': '现金资产比率(%)', 'X11': '技术人员占比(%)', 'X12': '研发营收比(%)',
    'X13': '发明专利申请数', 'X14': '数字化软硬件投入比(%)', 'X15': '数字化战略导向前瞻性',
    'X16': '数字化战略导向持续性', 'X17': '数字化战略导向广度', 'X18': '数字化战略导向强度', 'X19': '数字发明专利',
    'X20': '数字国家级奖项', 'X21': '数字创新论文', 'X22': '数字创新标准', 'X23': '数字创新资质',
    'X24': '管理层数字职务设立', 'X25': '两权分离率(%)', 'X26': '数字人力计划投入', 'X27': '数字资本计划投入',
    'X28': '科技创新基地建设', 'X29': '员工人均营收比(%)', 'X30': '提供岗位增长率(%)', 'X31': '员工收入增长率(%)',
    'X32': '社会责任报告质量', 'X33': '供应链合作伙伴', 'X34': '数字化供应链覆盖度', 'X35': '客户集中度(%)',
    'X36': '供应商集中度(%)'}

EvaluationIndicatorTable = load_ind_table()


def fill_na(dataset, rate=0.24):
    ...
    for stock in stocks:
        ...
        for name in names:
            if (cdata[name].dtype == 'float64') and (cdata[name].isnull().sum() > 0) and (
                    cdata[name].isnull().sum() < amount * rate):
...
def dump_formulation(latex=r"", filename="example", fontsize=12, lamb=1.8):
    ...
    filepath = Path(__file__).parent.parent / 'assert' / 'formulation' / f"{filename}.svg"
    if filepath.exists():
        os.remove(filepath)
...
if __name__ == '__main__':
    fu = r"\frac{1}{n}\sum_{i=1}^n{a_i+b_i}"

    dump_formulation(fu, filename="test")
    # print(config_path)
    # for item in EvaluationIndicatorTable:
    #     print(f'{item["准则层"]}:{item["指标层"]}={item["计算公式"]}')
